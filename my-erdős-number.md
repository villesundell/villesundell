...
**In this document we follow the format and interpretation of [the original Erdős-Bacon-Sabbath project](https://github.com/rchurchley/erdos-bacon-sabbath/issues?q=is%3Aissue), linking all the works of the kind, such as: acting generally instead of only in movies, publication instead of scientific paper, etc.** For reference, Douglas Adams is discussed in the [GitHub issue #16](https://github.com/rchurchley/erdos-bacon-sabbath/issues/16).

## Erdős 5 (via Stian Rødven Eide)
I am linked to [Paul Erdős](https://en.wikipedia.org/wiki/Paul_Erd%C5%91s) via an academic [Stian Rødven Eide](https://www.wikidata.org/wiki/Q101662382) ([Erdős 4](https://www.csauthors.net/stian-rodven-eide/)), with whom we published a book in 2009 called "[Free Beer 1.0](https://www.wikidata.org/wiki/Q121505012)" with a few others ([Amazon](https://www.amazon.com/dp/B005D2ZUUA)), giving me Erdős number 5 by the broader interpretation above. The book has been [cited](https://scholar.google.com/scholar?cites=17471154990118781681) in academic literature.
...
I am linked to the prominent investor [Marc Andreessen](https://en.wikipedia.org/wiki/Marc_Andreessen) via 4 non-public business arrangements because of a startup co-owned with [Jari Jaanto](https://fi.wikipedia.org/wiki/Jari_Jaanto).
